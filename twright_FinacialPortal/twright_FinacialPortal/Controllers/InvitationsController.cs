...
namespace twright_FinacialPortal.Controllers
{
    public class InvitationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,HouseholdId,Used,Code,RecipientEmail")] Invitation invitation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,HouseholdId,Used,Code,RecipientEmail")] Invitation invitation)
        {
            if (ModelState.IsValid)
            {
