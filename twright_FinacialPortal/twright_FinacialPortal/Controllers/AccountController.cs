...
namespace twright_FinacialPortal.Controllers
{
    ...
    public class AccountController : Controller
    {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    ...
                    else
                    {
                        ...
                        if (currentUserRole == "Lobbist")
                            return RedirectToAction("Lobby", "Home");
                        else if (currentUserRole == "Memeber")
                            return RedirectToAction("Dashboard", "Households");
                        else if (currentUserRole == "HeadofHousehold")
                            return RedirectToAction("Dashboard", "Households");
        ...
        {
            var myInviteRegVM = new InviteRegisterViewModel
            {
                Code = code,
                Email = email
            };

            return View(myInviteRegVM);
        }
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                var from = "Finacial Enterprise<travwright3@gmail.com>";
